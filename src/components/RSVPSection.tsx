  ...
  return (
    <section className="py-20 px-6">
      ...
      <motion.div
        ...
        viewport={{ once: true }}
      >
        <p className="font-script text-3xl text-gold-light">Tejaswi & Govardhan</p>
        <p className="text-sm text-muted-foreground font-body mt-2 tracking-[0.2em] uppercase">May 6, 2026</p>
